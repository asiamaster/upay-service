...
SELECT ufs.`payment_id`, ufs.`account_id`, ufs.`child_id`, ufs.`trade_type`, ufs.`action`, ufs.`balance`, ufs.`amount`, ufs.`type`, ufs.`type_name`, ufs.`description`, ufs.`created_time` FROM upay_fund_statement ufs INNER JOIN upay_fund_account ufa ON ufs.account_id = ufa.account_id WHERE ufa.mch_id=8 ORDER BY ufs.id;
...
SELECT ufs.`payment_id`, ufs.`account_id`, ufs.`child_id`, ufs.`trade_type`, ufs.`action`, ufs.`balance`, ufs.`amount`, ufs.`type`, ufs.`type_name`, ufs.`description`, ufs.`created_time` FROM upay_fund_statement ufs INNER JOIN upay_fund_account ufa ON ufs.account_id = ufa.account_id WHERE ufa.mch_id=9 ORDER BY ufs.id;
...
SELECT ufs.`payment_id`, ufs.`account_id`, ufs.`child_id`, ufs.`trade_type`, ufs.`action`, ufs.`balance`, ufs.`amount`, ufs.`type`, ufs.`type_name`, ufs.`description`, ufs.`created_time` FROM upay_fund_statement ufs INNER JOIN upay_fund_account ufa ON ufs.account_id = ufa.account_id WHERE ufa.mch_id=2 ORDER BY ufs.id;
...
SELECT ufs.`payment_id`, ufs.`account_id`, ufs.`child_id`, ufs.`trade_type`, ufs.`action`, ufs.`balance`, ufs.`amount`, ufs.`type`, ufs.`type_name`, ufs.`description`, ufs.`created_time` FROM upay_fund_statement ufs INNER JOIN upay_fund_account ufa ON ufs.account_id = ufa.account_id WHERE ufa.mch_id=6 ORDER BY ufs.id;
